          ...
          {services.map((service, index) => (
            ...
            >
              <div className="md:col-span-4">
                ...
                <h2 className="mt-2 font-heading text-3xl font-semibold text-sage">
                  {service.name}
                </h2>
                ...
                <p className="mt-1.5 text-base text-sage-dim">{service.bestFor}</p>
              </div>
              <div className="md:col-span-8 md:border-l md:border-sage-dim/20 md:pl-10">
                ...
                <ul className="mt-4 flex flex-col gap-3 border-t border-sage-dim/10 pt-4">
                  {service.includes.map((item) => (
                    <li key={item} className="flex items-start gap-3 text-base text-sage-dim">
